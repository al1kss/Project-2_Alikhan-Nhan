...
|    8    |    Add Code on Pi to interact with the server, receive, send, save data    |    Server-side functions for sensor data handling and user management implemented.    |     210 min    |         Nov 29         |     C     |
...
|    21   | Continue working on the Science Poster, fix all occurring glitches and bug |               Reviewed and refined the poster for clarity and accuracy.               |     25 min     |          Dec 8         |     D     |
