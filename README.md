...
|---------|-----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|------------------------|-----------|
| 1       | Write the Problem definition                                                            | Obtained a problem definition, understand what the situation is                                                                                                           | 15 min         | Nov 25                 | A         |
| 2       | Set up Raspberry Pi                                                                     | Enable VCC to connect remotely, update all packets                                                                                                                        | 30 min         | Nov 25                 |           |
| 3       | Finish the Success Criteria                                                             | Now we know the Success Criteria                                                                                                                                          | 20 min         | Nov 26                 | A         |
| 4       | Test BME-280                                                                            | Write test code for BME-280, set up the breadboard, just for testing                                                                                                      | 70 min         | Nov 26                 |           |
| 5       | Test DHT-11                                                                             | Write test code for DHT-11, connect to the breadboard                                                                                                                     | 30 min         | Nov 27                 |           |
| 6       | Add OLED screen                                                                         | Connect both sensors to the OLED screen for in real time (smth)                                                                                                           | 20 min         | Nov 27                 |           |
| 7       | Start writing Real code on PI                                                           | Finish function to read data from the sensors and save it on dictionary                                                                                                   | 80 min         | Nov 28                 |           |
| 8       | Add more code                                                                           | Finish server-side functions: create sensors on the server, upload data from sensors to the server, create a new user, update token, get all reading from specific sensor | 210 min        | Nov 29                 |           |
| 9       | Add code for OLED screen                                                                | Establish secure connection between Raspberry Pi and OLED screen                                                                                                          |                |                        |           |
| 10      | Establish data collection, file saving using CSV                                        | Begin data collection with CSV file integration                                                                                                                           | 30 min         | Nov 30                 |           |
| 11      | Code a comparative analysis graphs of temperature, humidity from 2 sensors and pressure | Added code to get data readings from the server, with further implementation of code to draw 48 hour graph                                                                | 40 min         | Dec 2                  |           |
| 12      | Code for the graph smoothing                                                            | Refine code to smooth the data gained from the sensors, using defined methods and concepts                                                                                | 20 min         | Dec 2                  |           |
| 13      |                                                                                         |                                                                                                                                                                           |                |                        |           |
| 14      |                                                                                         |                                                                                                                                                                           |                |                        |           |
| 15      |                                                                                         |                                                                                                                                                                           |                |                        |           |
| 16      |                                                                                         |                                                                                                                                                                           |                |                        |           |
